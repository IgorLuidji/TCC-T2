...
router.get('/exportar-pdf', checkAuth.bind(undefined, 'event','export'), asyncHandler(EventController.exportPdf))
...
router.get('/exportar-csv', checkAuth.bind(undefined, 'event','export'), asyncHandler(EventController.exportCsv))
